...
// Generated for xiAPI version 4.11.09
...
public:
	...
	XI_BIN_PATTERN GetBinningPattern();
	XI_BIN_PATTERN GetBinningPattern_Maximum();	
	XI_BIN_PATTERN GetBinningPattern_Minimum();
	int GetBinningPattern_Increment();
	void SetBinningPattern(XI_BIN_PATTERN BinningPattern);
	...
	XI_DEC_PATTERN GetDecimationPattern();
	XI_DEC_PATTERN GetDecimationPattern_Maximum();	
	XI_DEC_PATTERN GetDecimationPattern_Minimum();
	int GetDecimationPattern_Increment();
	void SetDecimationPattern(XI_DEC_PATTERN DecimationPattern);
	...
	int GetWhiteBalanceManualNow();
	int GetWhiteBalanceManualNow_Maximum();
	int GetWhiteBalanceManualNow_Minimum();
	int GetWhiteBalanceManualNow_Increment();
	...
	int GetColorCorrectionMatrixDefault();
	int GetColorCorrectionMatrixDefault_Maximum();
	int GetColorCorrectionMatrixDefault_Minimum();
	int GetColorCorrectionMatrixDefault_Increment();
	...
	int GetTriggerSoftware();
	int GetTriggerSoftware_Maximum();
	int GetTriggerSoftware_Minimum();
	int GetTriggerSoftware_Increment();
	...
	int GetLensFocusMove();
	int GetLensFocusMove_Maximum();
	int GetLensFocusMove_Minimum();
	int GetLensFocusMove_Increment();
	...
	XI_GPI_SELECTOR GetTriggerDelay();
	XI_GPI_SELECTOR GetTriggerDelay_Maximum();	
	XI_GPI_SELECTOR GetTriggerDelay_Minimum();
	int GetTriggerDelay_Increment();
	void SetTriggerDelay(XI_GPI_SELECTOR TriggerDelay);
	...
	int GetDeviceReset();
	int GetDeviceReset_Maximum();
	int GetDeviceReset_Minimum();
	int GetDeviceReset_Increment();
	...
	int GetHWRevision();
	int GetHWRevision_Maximum();
	int GetHWRevision_Minimum();
	int GetHWRevision_Increment();
